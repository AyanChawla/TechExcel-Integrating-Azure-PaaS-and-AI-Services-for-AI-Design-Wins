...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]    
    [Description("Get Bookings for and dates hotels.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The Date for booking of the hotel")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get Missed Bookings from hotels.")]
